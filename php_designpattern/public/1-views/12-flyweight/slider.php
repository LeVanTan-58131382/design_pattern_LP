...
<div id="demo" class="carousel slide" data-ride="carousel" data-interval="false">
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img src="../public/images/12-flyweight/flyweight.png" alt="UML" style="margin-left: 10%;margin-top: 10%;">
            <div class="carousel-caption" style=" top: 0;bottom: auto;">
        ...
        <div class="carousel-item">
            <img src="../public/images/12-flyweight/DesignPatterns-Flyweight.png" alt="UML" style="margin-left: 10%;margin-top: 10%;">
            <div class="carousel-caption" style=" top: 0;bottom: auto;">
