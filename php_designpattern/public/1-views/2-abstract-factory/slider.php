    ...
    <div id="demo" class="carousel slide" data-ride="carousel" data-interval="false">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active" style="vertical-align:middle; text-align:center">
                <img src="../public/images/2-abstract-factory/abstract-factory-en.png" alt="Hình minh họa" style="margin-top: 14%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong>Hình minh họa</strong></h2>
                </div>
            </div>
            <div class="carousel-item" style="vertical-align:middle; text-align:center">
                <img src="../public/images/2-abstract-factory/customer.png" alt="Hình minh họa" style="margin-top: 14%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: blue;"><strong>Vấn đề của Abstract Factory</strong></h2>
                </div>
            </div>
            <div class="carousel-item" style="vertical-align:middle; text-align:center">
                <img src="../public/images/2-abstract-factory/abstractfactory.png" alt="Cấu trúc" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
