    ...
    <div id="demo" class="carousel slide" data-ride="carousel" data-interval="false">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active" style="vertical-align:middle; text-align:center">
                <img src="../public/images/14-chain-of-responsitory/chain-of-responsibility-comic-1-en.png" alt="Hình minh họa" style="margin-top: 14%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong>Hình minh họa</strong></h2>
                </div>
            </div>
            ...
            <div class="carousel-item" style="vertical-align:middle; text-align:center">
                <img src="../public/images/14-chain-of-responsitory/solution1-en.png" alt="Cấu trúc" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong></strong></h2>
                </div>
            </div>
            <div class="carousel-item" style="vertical-align:middle; text-align:center">
                <img src="../public/images/14-chain-of-responsitory/UMLMinhHoa.png" alt="Cấu trúc" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong>Ý Tưởng</strong></h2>
                </div>
            </div>
            <div class="carousel-item" style="vertical-align:middle; text-align:center">
                <img src="../public/images/14-chain-of-responsitory/UML.png" alt="Cấu trúc" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
            ...
            <!-- <div class="carousel-item active">
                <img src="image/chain.jpg" alt="UML" style="margin-left: 10%;margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong>Mô hình UML</strong></h2>
                </div>
            </div> -->
