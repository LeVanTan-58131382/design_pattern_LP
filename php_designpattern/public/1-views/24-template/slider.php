<div class="col-sm-6">
            <div id="demo" class="carousel slide" data-ride="carousel" data-interval="false">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <img src="../public/images/24-template/template-method.png" alt="Hình minh họa" style="margin-left: 10%;margin-top: 10%;">
                        <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    ...
                    <!--<div class="carousel-item">
                        <img src="image/template2.png" alt="UML" style="margin-left: 10%;margin-top: 10%;">
                        <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    ...
                    <div class="carousel-item">
                        <img src="../public/images/24-template/DesignPatterns-Template.png" alt="UML" style="margin-left: 10%;margin-top: 10%;">
                        <div class="carousel-caption" style=" top: 0;bottom: auto;">
                            <h2 style="color: red;"><strong>Mô hình UML</strong></h2>
                        </div>
                    </div>
