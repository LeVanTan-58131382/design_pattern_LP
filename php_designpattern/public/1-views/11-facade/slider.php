    ...
    <div class="carousel-inner">
        <div id="demo" class="carousel slide" data-ride="carousel" data-interval="false">
            ...
            <div class="carousel-item active" style="vertical-align:middle; text-align:center">
                <img src="../public/images/11-facade/minhhoa.PNG" alt="Hình minh họa" style="margin-top: 14%;">
            ...
            <div class="carousel-item"  style="vertical-align:middle; text-align:center">
                <img src="../public/images/11-facade/cautruc.PNG" alt="Cấu trúc" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong>Cấu trúc</strong></h2>
                </div>
            </div>
            <div class="carousel-item"  style="vertical-align:middle; text-align:center">
                <img src="../public/images/11-facade/magia.PNG" alt="Mã giả" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
                    <h2 style="color: black;"><strong>Mã giả</strong></h2>
                </div>
            </div>
            <div class="carousel-item ">
                <img src="../public/images/11-facade/facade.jpg" alt="UML" style="margin-top: 10%;">
                <div class="carousel-caption" style=" top: 0;bottom: auto;">
