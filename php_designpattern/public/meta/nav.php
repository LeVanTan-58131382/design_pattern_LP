            ...
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item active dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownId">
                        ...
                        <a class="dropdown-item" href="../2-abstract-factory/main.php">Part 2 - Thanh Hai</a>
                    </div>
                </li>
                <li class="nav-item active dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownId">
                        ...
                        <a class="dropdown-item" href="../9-composite/main.php">2. Composite Pattern</a>
                ...
                <!-- <a class="nav-link" href="../DesignPattern.html">Full Diagram Design Pattern</a>
                <a class="nav-link" href="../demo1.html">Diagram CPE</a>
                <a class="nav-link" href="../demo2.html">Diagram CFSRPE</a>
                <a class="nav-link" href="../demo3.html">Diagram CRCMD</a> -->
            </ul>
        </div>
    </nav>